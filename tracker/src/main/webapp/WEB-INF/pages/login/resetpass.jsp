...
<body>
	...
	<hr>
		<form class="contactForm" id="contactForm" onsubmit="alert('Please check your email and follow the instructions to change your password.')" method="POST" action= "" role="form">
