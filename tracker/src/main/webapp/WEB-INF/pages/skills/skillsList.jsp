				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="col-lg-1 col-sm-2"><a href="/edit-skill?id=${gen.id}" ><button class="btnE" id="editBtn"><img src="../resource/edit.png" width="20" height="20"/></button></a></td>
							<td class="col-lg-1 col-sm-2"><a href="/delete-skill?id=${gen.id}" ><button class="btnD"><img src="../resource/del.png" width="20" height="20"/></button></a></td>
						</tr>
					</c:forEach>
					</tbody>
				</table>
